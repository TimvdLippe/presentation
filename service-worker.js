...
var precacheConfig = [["index.html","7d3aeb49484b7b6e690a79b16772a2d2"]];
var cacheName = 'sw-precache-v2-timvdlippe-presentation-' + (self.registration ? self.registration.scope : '');
...
toolbox.router.get(/.*googleusercontent\.com.*/, toolbox.fastest, {});
toolbox.router.get(/.*webcomponents\.org.*/, toolbox.fastest, {});
